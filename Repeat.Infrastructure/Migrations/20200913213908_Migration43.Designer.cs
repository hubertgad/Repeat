...
namespace Repeat.Data.Migrations
{
    ...
    [Migration("20200913213908_Migration43")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repeat.Domain.Models.ChoosenAnswer", b =>
                {
                    ...
                    b.Property<int?>("TestQuestionQuestionID")
                        .HasColumnType("int");

                    b.Property<int?>("TestQuestionTestID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("TestQuestionTestID", "TestQuestionQuestionID");
            ...
            modelBuilder.Entity("Repeat.Domain.Models.ChoosenAnswer", b =>
                {
                    b.HasOne("Repeat.Domain.Models.TestQuestion", null)
                        .WithMany("ChoosenAnswers")
                        .HasForeignKey("TestQuestionTestID", "TestQuestionQuestionID");
                });
            ...
            modelBuilder.Entity("Repeat.Domain.Models.TestQuestion", b =>
                {
                    ...
                    b.HasOne("Repeat.Domain.Models.Test", null)
                        .WithOne("CurrentQuestion")
                        .HasForeignKey("Repeat.Domain.Models.TestQuestion", "TestID1");
                });
