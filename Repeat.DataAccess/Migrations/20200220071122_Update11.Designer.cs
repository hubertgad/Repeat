...
namespace Repeat.Data.Migrations
{
    ...
    [Migration("20200220071122_Update11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repeat.Models.AnswerPoint", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("QuestionPointID");

                    b.ToTable("AnswerPoints");
                });
            ...
            modelBuilder.Entity("Repeat.Models.OuestionPoint", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Repeat.Models.AnswerPoint", b =>
                {
                    b.HasOne("Repeat.Models.OuestionPoint", "QuestionPoint")
                        .WithMany()
                        .HasForeignKey("QuestionPointID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
